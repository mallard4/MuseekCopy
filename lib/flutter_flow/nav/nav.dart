...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const HamepageWidget() : const IntroWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'Hamepage',
          path: '/hamepage',
          builder: (context, params) => const HamepageWidget(),
        ),
        FFRoute(
          name: 'ChatPage',
          path: '/chatPage',
          asyncParams: {
            ...
            'newchat': getDoc(['chats'], ChatsRecord.fromSnapshot),
          },
        ...
        FFRoute(
          name: 'Public_Profile',
          path: '/publicProfile',
          builder: (context, params) => const PublicProfileWidget(),
        ),
        FFRoute(
          name: 'User_Search',
          path: '/userSearch',
        ...
        FFRoute(
          name: 'Photo_And_Video_Editor',
          path: '/photoAndVideoEditor',
          builder: (context, params) => const PhotoAndVideoEditorWidget(),
        ),
        FFRoute(
          name: 'Sign_UpByPhone',
          path: '/signUpByPhone',
          builder: (context, params) => SignUpByPhoneWidget(
        ...
        FFRoute(
          ...
          path: '/signUpWelcome',
          builder: (context, params) => const SignUpWelcomeWidget(),
        ),
        FFRoute(
          name: 'SMS_Verify_Sign_Up',
          path: '/sMSVerifySignUp',
          builder: (context, params) => SMSVerifySignUpWidget(
        ...
        FFRoute(
          name: 'SMS_Verify_Login',
          path: '/sMSVerifyLogin',
          builder: (context, params) => SMSVerifyLoginWidget(
            phoneNumber: params.getParam('phoneNumber', ParamType.String),
            isLogin: params.getParam('isLogin', ParamType.bool),
          ),
        ),
        FFRoute(
          name: 'Login_Welcome',
          path: '/loginWelcome',
          builder: (context, params) => const LoginWelcomeWidget(),
        ),
        FFRoute(
          name: 'Edit_Account',
          path: '/editAccount',
        ...
        FFRoute(
          name: 'Museek_Library',
          path: '/museekLibrary',
          builder: (context, params) => const MuseekLibraryWidget(),
        ),
        FFRoute(
          name: 'Search_Library',
          path: '/searchLibrary',
          builder: (context, params) => const SearchLibraryWidget(),
        ),
        FFRoute(
          name: 'Intro',
          path: '/intro',
        ...
        FFRoute(
          name: 'Admin_Control_Page',
          path: '/adminControlPage',
          builder: (context, params) => const AdminControlPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'Camera_Homepage',
          path: '/cameraHomepage',
          builder: (context, params) => const CameraHomepageWidget(),
        )
